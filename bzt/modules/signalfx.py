...
class SignalfxUploader(Reporter, AggregatorListener, MonitoringListener, Singletone):
    """
    Reporter class
    ...
    def __send_data(self, data, do_check=True, is_final=False):
        ...
        if not self._session:
            return
        self.log.info("::::::::::::::::::")
        #self.log.info(type(data[0]["cumulative"]['/']["rt"]))
        #self.log.info("::::::::::::::::::")
...
class CloudProvisioning(MasterProvisioning, WidgetProvider):
    ...
    def _get_other_modules(config):
        used_classes = LocalClient.__name__, SignalfxUploader.__name__
        used_modules = []
